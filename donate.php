	...
	if (isset($_POST['term']) === true) {
		...
		if (isset($_POST['name']) && !empty($_POST['name'])) {
			...
			if (preg_match('/^[A-Za-z\s]+$/', $_POST['name'])) {
				...
				$nameError = '<div class="alert alert-danger alert-dismissible fade show"
					role="alert">
		...
		if (isset($_POST['gender']) && !empty($_POST['gender'])) {
			...
			$genderError = '<div class="alert alert-danger alert-dismissible fade show"
					role="alert">
		...
		if (isset($_POST['day']) && !empty($_POST['day'])) {
			...
			$dayError = '<div class="alert alert-danger alert-dismissible fade show"
					role="alert">
		...
		if (isset($_POST['month']) && !empty($_POST['month'])) {
			...
			$monthError = '<div class="alert alert-danger alert-dismissible fade show"
					role="alert">
		...
		if (isset($_POST['year']) && !empty($_POST['year'])) {
			...
			$yearError = '<div class="alert alert-danger alert-dismissible fade show"
					role="alert">
		...
		if (isset($_POST['blood_group']) && !empty($_POST['blood_group'])) {
			...
			$blood_groupError = '<div class="alert alert-danger alert-dismissible fade show"
					role="alert">
		...
		if (isset($_POST['city']) && !empty($_POST['city'])) {
			if (preg_match('/^[A-Za-z\s]+$/', $_POST['city'])) {
				...
				$cityError = '<div class="alert alert-danger alert-dismissible fade show"
					role="alert">
					<strong>Only lower and upper case and space characters are allowed.</strong>
					<button type="button" class="close" data-dismiss="alert" aria-label="Close">
					<span aria-hidden="true">&times;</span>
		...
		if (isset($_POST['contact_no']) && !empty($_POST['contact_no'])) {
			if (preg_match('/\d{9}/', $_POST['contact_no'])) {
				$contact = $_POST['contact_no'];
			} else {
				$contactError = '<div class="alert alert-danger alert-dismissible fade show"
					role="alert">
					<strong>Contact should be 9 digits.</strong>
					<button type="button" class="close" data-dismiss="alert" aria-label="Close">
					<span aria-hidden="true">&times;</span>
					</button>
					</div>';
		...
		if (
			isset($_POST['password']) && !empty($_POST['password']) && isset($_POST['c_password']) &&
			...
			if (strlen($_POST['password']) >= 6) {
				...
				$passwordError = '<div class="alert alert-danger alert-dismissible fade show" role="alert">
									<strong>Password should consist atleast six characters.</strong>
									<button type="button" class="close" data-dismiss="alert" aria-label="Close">
									<span aria-hidden="true">&times;</span>
									</button>
									</div>';
		...
		if (isset($_POST['email']) && !empty($_POST['email'])) {
			...
			if (preg_match($pattern, $_POST['email'])) {
				...
				if (mysqli_num_rows($result) > 0) {
					$emailError = '<div class="alert alert-danger alert-dismissible fade show"
					role="alert">
					<strong>Sorry this email is already in use.</strong>
					<button type="button" class="close" data-dismiss="alert" aria-label="Close">
					<span aria-hidden="true">&times;</span>
					</button>
					</div>';
		...
		if (isset($name) && isset($blood_group) && isset($gender) && isset($day) && isset($month) && isset($year) && isset($email) && isset($contact) && isset($password)) {
		...
		<div class="col-md-6 offset-md-3 form-container">
			...
			<form class="form-group" action="" method="post">
				...
				<div class="form-group">
					...
					<input type="text" name="contact_no" placeholder="237********" class="form-control" required pattern="^\d{12}$" title="12 numeric characters only" maxlength="12" value="<?php if (isset($contact)) echo $contact; ?>">
				...
				<div class="form-inline">
					...
					<span style="margin-left:10px;"><b>I am agree to donate my blood and show my Name, Contact Number, and E-Mail in Blood donors List</b></span>
				</div><!--End form-group-->
